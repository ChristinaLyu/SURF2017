...
os.system('java -jar ' + JMOLDATA_JAR + ' -no -j "load ' + inputPdbFilePath + ' ; select protein; getproperty atomInfo;" > '+tempFolderPath+ 'atominfo.txt')
os.system('java -jar ' + JMOLDATA_JAR + ' -no -j "load ' + inputPdbFilePath + ' ; select protein; getproperty bondInfo;" > '+tempFolderPath+'bondinfo.txt')
