...
if __name__ == "__main__":
    ...
    output_file = os.path.join(output_folder,file_name+"_sol.pdb")
    ...
    try:
        os.system('java -XX:-UseGCOverheadLimit -jar '+JMOLDATA_JAR+' -n -j '+"'"+'load '+input_file+'; select solvent and not ligand; x=write("PDB"); write VAR x "'+output_file+'";'+"'")
    except IOError:
